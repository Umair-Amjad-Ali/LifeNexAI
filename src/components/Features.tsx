...
import { Shield, Users, Layers, Settings, Activity } from "lucide-react";
import { COLORS } from "@/constants/colors";

export function Features() {
  return (
    <section id="about" className="bg-white py-16 md:py-20 border-t border-slate-200">
      <div className="mx-auto max-w-[1200px] px-8 sm:px-12 lg:px-16">
        
        {/* Section Header */}
        <div className="mb-12">
          <span 
            className="inline-flex items-center justify-center px-4 py-1.5 rounded-full border text-[9px] font-black tracking-[0.25em] uppercase mb-4"
            style={{ borderColor: `${COLORS.primary}40`, backgroundColor: `${COLORS.primary}08`, color: COLORS.primary }}
          >
            ✦ TECHNICAL ABILITIES ✦
          </span>
          <h2 className="text-3xl sm:text-4xl font-black tracking-tight leading-none text-slate-900 select-none font-sans uppercase">
            Engineering Guidelines
          </h2>
          <p className="text-slate-600 text-sm max-w-xl mt-3 leading-relaxed font-semibold">
            We deliver medical software and custom AI pipelines using enterprise-grade engineering principles, secure database integrations, and high-performance client frameworks.
          </p>
        </div>
        ...
        <div className="relative">
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-6 gap-6">
            ...
            {/* Card 1: AI Core Pipelines */}
            <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 border border-slate-200 bg-white hover:border-primary/40 hover:shadow-lg transition-all duration-300 rounded-xl">
              <CardContent className="relative m-auto size-fit pt-6 pb-6 text-center">
                <div className="relative flex h-24 w-56 items-center justify-center mx-auto">
                  ...
                  <span className="mx-auto block w-fit text-5xl font-black text-slate-900 font-sans tracking-tight">100%</span>
                </div>
                <h3 className="mt-4 text-base font-extrabold tracking-wider uppercase text-slate-900">AI Core Pipelines</h3>
                <p className="text-sm text-slate-600 mt-2 font-medium leading-relaxed">
                  Integrating customized deep learning models, analytical telemetry, and automated intelligence layers directly into operational environments.
                </p>
              </CardContent>
            </Card>

            {/* Card 2: Security & HIPAA Compliance */}
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 border border-slate-200 bg-white hover:border-primary/40 hover:shadow-lg transition-all duration-300 rounded-xl">
              <CardContent className="pt-6 pb-6 text-center">
                <div 
                  className="relative mx-auto flex aspect-square size-20 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border"
                  style={{ borderColor: `${COLORS.primary}30`, outlineColor: `${COLORS.primary}10` } as any}
                >
                  <svg 
                    className="m-auto h-fit w-12" 
                    viewBox="0 0 212 143" 
                    fill="none" 
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  >
                    <path
                      ...
                      fill="currentColor"
                    />
                    <path d="M3 72H209" stroke="currentColor" strokeWidth="6" strokeLinecap="round" />
                    <defs>
                ...
                <div className="relative z-10 mt-4 space-y-2">
                  <h3 className="text-base font-extrabold tracking-wider uppercase text-slate-900">Security & HIPAA Compliance</h3>
                  <p className="text-sm text-slate-600 max-w-xs mx-auto font-medium leading-relaxed">
                    Deploying end-to-end data encryption, active database telemetry compliance, and secure user audit trails to safeguard patient information.
                  </p>
                </div>
              </CardContent>
            </Card>

            {/* Card 3: High-Performance Web */}
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 border border-slate-200 bg-white hover:border-primary/40 hover:shadow-lg transition-all duration-300 rounded-xl">
              <CardContent className="pt-6 pb-6 text-center">
                <div className="pt-4 lg:px-6">
                  ...
                  >
                    ...
                    <g clipPath="url(#clip0_0_106)">
                      <circle cx="29" cy="29" r="15" fill="currentColor" className="opacity-10" />
                      <path d="M29 23V35" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M35 29L29 35L23 29" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                      <path
                    ...
                    <defs>
                      <linearGradient id="paint0_linear_0_106" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                        <stop stopColor="currentColor" className="text-primary/10" />
                ...
                <div className="relative z-10 mt-4 space-y-2">
                  <h3 className="text-base font-extrabold tracking-wider uppercase text-slate-900">Modern Web Interfaces</h3>
                  <p className="text-sm text-slate-600 max-w-xs mx-auto font-medium leading-relaxed">
                    Developing ultra-fast, responsive web interfaces, telemetry-driven administrator dashboards, and real-time visualization systems utilizing React and Next.js.
                  </p>
                </div>
              </CardContent>
            </Card>

            {/* Card 4: Cloud-Native Infrastructure */}
            <Card className="relative col-span-full overflow-hidden lg:col-span-3 border border-slate-200 bg-white hover:border-primary/40 hover:shadow-lg transition-all duration-300 rounded-xl">
              <CardContent className="grid pt-6 pb-6 sm:grid-cols-2 gap-6 items-center">
                <div className="relative z-10 flex flex-col justify-between h-full space-y-4">
                  <div 
                    ...
                    style={{ borderColor: `${COLORS.primary}30`, outlineColor: `${COLORS.primary}10` } as any}
                  >
                    <Shield className="m-auto size-5" strokeWidth={1.5} style={{ color: COLORS.primary }} />
                  </div>
                  <div className="space-y-2">
                    <h3 className="text-base font-extrabold tracking-wider uppercase text-slate-900">Cloud Infrastructure</h3>
                    <p className="text-sm text-slate-600 font-medium leading-relaxed">
                      Architecting high-availability servers, microservice APIs, secure FHIR data storage, and containerized backend systems on AWS and Google Cloud.
                    </p>
                  </div>
                </div>
                <div className="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-0 h-fit border-l border-t p-6 py-6 sm:ml-6 border-slate-200 bg-slate-50/50">
                  <div className="absolute left-3 top-2 flex gap-1">
                    <span className="block size-2 rounded-full border border-slate-200 bg-slate-100"></span>
                    <span className="block size-2 rounded-full border border-slate-200 bg-slate-100"></span>
                    <span className="block size-2 rounded-full border border-slate-200 bg-slate-100"></span>
                  </div>
                  <svg 
            ...
            {/* Card 5: Cross-Platform Mobile */}
            <Card className="relative col-span-full overflow-hidden lg:col-span-3 border border-slate-200 bg-white hover:border-primary/40 hover:shadow-lg transition-all duration-300 rounded-xl">
              <CardContent className="grid h-full pt-6 pb-6 sm:grid-cols-2 gap-6 items-center">
                <div className="relative z-10 flex flex-col justify-between h-full space-y-4">
                  <div 
                    className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border"
                    style={{ borderColor: `${COLORS.primary}30`, outlineColor: `${COLORS.primary}10` } as any}
                  >
                    <Users className="m-auto size-6" strokeWidth={1.5} style={{ color: COLORS.primary }} />
                  </div>
                  <div className="space-y-2">
                    <h3 className="text-base font-extrabold tracking-wider uppercase text-slate-900">Mobile Engineering</h3>
                    <p className="text-sm text-slate-600 font-medium leading-relaxed">
                      Engineering high-performance native and cross-platform apps using Flutter and React Native, optimized for modern healthcare environments.
                    </p>
                  </div>
                </div>
                <div className="before:bg-slate-200 relative mt-0 before:absolute before:inset-y-0 before:left-0 before:w-px sm:-my-6 sm:-mr-6 border-t sm:border-t-0 sm:border-l border-slate-200 pl-6 bg-white flex flex-col justify-center py-6">
                  <div className="relative flex h-full flex-col justify-center space-y-6">
                    <div className="relative flex w-full items-center gap-2">
                      <div className="size-7 rounded-full overflow-hidden border border-slate-200 shadow-sm">
                        <img className="size-full object-cover" src="https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&q=80&w=120" alt="Engineer" />
                      </div>
                      <span className="block h-fit rounded border border-slate-200 bg-slate-50 px-2 py-1 text-[10px] text-slate-600 font-bold tracking-wider uppercase shadow-xs">Lead Dev</span>
                    </div>
                    <div className="relative flex items-center gap-2">
                      <div className="size-8 rounded-full overflow-hidden border border-slate-200 shadow-sm">
                        <img className="size-full object-cover" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=120" alt="Developer" />
                      </div>
                      <span className="block h-fit rounded border border-slate-200 bg-slate-50 px-2 py-1 text-[10px] text-slate-600 font-bold tracking-wider uppercase shadow-xs">Senior UI</span>
                    </div>
                    <div className="relative flex w-full items-center gap-2">
                      <div className="size-7 rounded-full overflow-hidden border border-slate-200 shadow-sm">
                        <img className="size-full object-cover" src="https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&q=80&w=120" alt="DevOps" />
                      </div>
                      <span className="block h-fit rounded border border-slate-200 bg-slate-50 px-2 py-1 text-[10px] text-slate-600 font-bold tracking-wider uppercase shadow-xs">Cloud Sec</span>
                    </div>
                  </div>
                </div>
              </CardContent>
