...
// Locked to your requested white/light background palette
const palette = {
...
export function FAQ1() {
  ...
  return (
    ...
    >
      ...
      {/* --- UPDATED WRAPPER: Changed max-w-4xl and lg:max-w-5xl to w-full max-w-[1200px] --- */}
      <section
        className={`relative z-10 mx-auto flex w-full max-w-300 flex-col gap-12 px-6 py-12 lg:px-12 ${
